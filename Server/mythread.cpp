 ...
 * \param data
 */
void qbyteToDouble(QByteArray DataQByte, VehicleDataProvider data)
{
 ...
 * \param data_values
 */
void MyThread::setData(VehicleDataProvider data_values)
{
 ...
 * \return
 */
VehicleDataProvider MyThread::getData()
{
    return this->data;
}
